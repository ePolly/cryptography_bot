...
@router.callback_query(Text(text='code_caesar'))
...
@router.callback_query(Text(text='decode_caesar'))
async def process_tasks_press(callback: CallbackQuery):
    users_db[callback.from_user.id]['task'] = callback.data
...
@router.callback_query(Text(text='code_caesar_message'))
...
@router.callback_query(Text(text='code_atbash_message'))
async def process_edit_press(callback: CallbackQuery):
    users_db[callback.from_user.id]['task'] = callback.data
    await callback.message.answer(
...
@router.callback_query(Text(text='code_atbash'))
async def process_tasks_press(callback: CallbackQuery):
    users_db[callback.from_user.id]['task'] = callback.data
...
@router.callback_query(Text(text='decode_atbash'))
async def process_tasks_press(callback: CallbackQuery):
    users_db[callback.from_user.id]['task'] = callback.data
...
@router.callback_query(Text(text='code_slogan_message'))
async def process_edit_press(callback: CallbackQuery):
    users_db[callback.from_user.id]['task'] = callback.data
    await callback.message.answer(
                text=f'{LEXICON[callback.data]}\n',
...
@router.callback_query(Text(text='decode_akros'))
async def process_tasks_press(callback: CallbackQuery):
    users_db[callback.from_user.id]['task'] = callback.data
