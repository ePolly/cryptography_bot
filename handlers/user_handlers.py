...
@router.callback_query(Text(text='main_return'), ~StateFilter(default_state))
...
@router.callback_query(Text(text='audio'), ~StateFilter(default_state))
...
@router.callback_query(Text(text='forward'), ~StateFilter(FSMReadSolve.solve_task))
...
# во время взаимодействия пользователя с сообщением-книгой
@router.callback_query(Text(text='backward'), ~StateFilter(FSMReadSolve.solve_task))
